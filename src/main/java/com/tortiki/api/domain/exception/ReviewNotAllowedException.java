...
/**
 * Levée lorsqu'un acheteur tente de noter sans demande confirmée.
 */
public class ReviewNotAllowedException extends RuntimeException {
   ...
   */
  public ReviewNotAllowedException(String reviewerEmail, Long listingId) {
    super("L'utilisateur " + reviewerEmail
        + " ne peut pas noter l'annonce #" + listingId
        + " sans demande confirmée");
  }
}